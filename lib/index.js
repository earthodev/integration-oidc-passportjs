...
function Strategy(options, verify) {
  ...
  var defaultOptions = {
    expectedIssuer: 'https://account.eartho.io',
    authorizationURL: 'https://account.eartho.io/api/oidc/auth',
    tokenURL: 'https://account.eartho.io/api/oidc/token',
    userInfoURL: 'https://account.eartho.io/api/oidc/userinfo',
  }
